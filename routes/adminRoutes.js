...
var userSettingService = require('../models/userSetting');
...
admin.post('/add-promotional-banner', function (req, res) {
  adminService.addBanner(req.body, req.files, function (response) {
    res.send(response);
  });
});

//Edit promotional banner
admin.post('/edit-promotional-banner', function (req, res) {
  adminService.editBanner(req.body, req.files, function (response) {
    res.send(response);
  });
});

//list promotional banner
admin.post('/list-promotional-banner', function (req, res) {
  adminService.bannerList(req.body, function (response) {
    res.send(response);
  });
});
...
///// CREDIT SYSTEM START /////////
//All Credit List
admin.get('/list-credit-system', function (req, res) {
  creditService.creditSystemList(req.query, function (response) {
    res.send(response);
  });
});

//Add Credit System
admin.post('/add-credit-system', function (req, res) {
  creditService.addCreditSystem(req.body, function (response) {
    res.send(response);
  });
});

//Update Credit System
admin.put('/update-credit-system', function (req, res) {
  creditService.updateCreditSystem(req.body, function (response) {
    res.send(response);
  });
});

//Update Credit Status
admin.put('/update-credit-status', function (req, res) {
  creditService.updateCreditStatus(req.body, function (response) {
    res.send(response);
  });
});

//Update User Credit System
admin.put('/update-user-credit', function (req, res) {
  creditService.updateUserCredit(req.body, function (response) {
    res.send(response);
...
//edit User Clovers
admin.put('/update-user-clover', function (req, res) {
  adminService.UpdateUserClovers(req.body, function (response) {
    res.send(response);
  });
});
// Delete User
...
//<-----user setings  routes------->
admin.get('/list-user-setting', function (req, res) {
  userSettingService.userSettingList(req.query, function (result) {
    res.send(result);
  });
});
admin.post('/user-setting-details', function (req, res) {
  userSettingService.userSettingdetails(req.body, function (result) {
    res.send(result);
  })
});

admin.put('/update-user-setting', function (req, res) {
  userSettingService.editUserSetting(req.body, function (result) {
    res.send(result);
  })
});
