              ...
              <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td class="content-cell">
                    <p>Hi, {{ name }}</p>
                    <p>You have request update email from {{ email }} to {{ newemail }}</p>
                    <p>Please use the link below to reset your email. Link will be valid for next 48 hrs only.</p>
                    <!-- Action -->
                      ...
                      <tr>
                        <td align="center">
                          ...
                          <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: auto;">
                              ...
                              <span style="color:#ffffff">Reset Email</span>
                              </a>
                              </td>
                              </tr>
                          </table>
                    ...
                    <p>Have a great day!<br>Team EZfoodie</p>
                  </td>
                </tr>
              </table>
            </td>
