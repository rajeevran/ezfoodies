...
module.exports = function (mailType) {
    ...
    var mailDict = {
        ...
        "restManagerSignUpMail": {
            subject: "Welcome to EZfoodie as a Restaurant Manager",
            html: require('./restManagerSignUpMail')
        },
        "restautantAddMail": {
            subject: "Restaurant Added Successfully",
            html: require('./restaurantAddMail')
        },
