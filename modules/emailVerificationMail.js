    ...
    <div style="width:600px;margin:0 auto;background-image: url({{ site_url }}uploads/email_template/top_bg.png);background-repeat: no-repeat; text-align: center;">\
        ...
        <div style="margin-top: 8%;text-align: center;">\
            <ul style="list-style: none;">\
                ...
                <li><img src="{{ site_url }}uploads/email_template/welcome.png" alt="wc-message"></li>\
                <li style="margin-top:10px;">Your Activation Code is <b style="font-weight: 900;color:#0e0d1f;">{{ verification_code }}</b> . Please use this code and activate your account.</li>\
            </ul>\
        </div>\
        <img src="{{ site_url }}uploads/email_template/phone2.png" alt="phone-view" style="margin-top:40px;">\
        <div style="margin-top: 5%; background-color: white;text-align: center;"> \
        <ul style ="list-style: none; margin-top:10px" >\
            <li> <img src="{{ site_url }}uploads/email_template/ready_to_place.png" alt ="ready_to_place" ></li>\
        </ul>\
        </div>\
