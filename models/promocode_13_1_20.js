...
console.log('---1st promoFlag--',promoFlag)
   ...
   .aggregate([
       ...
       // define some conditions here 
       {
        ...
        {
            $group: {_id:'$order_info',uniqueCount: {$addToSet: "$_id"}}
        }
   ...
   //#region calculate promocode amount
    ...
    let promise = new Promise(  function(resolve, reject) {
        ...
        checkResponse.map( async function(data) { 
                    ...
                    // true condition
                    let flag=0
                    flag= data.response_data.length !== 0  ? data.response_data[0].uniqueCount.length:0
                    ...
                    if(data.response_data.length>=1 )
                    {
                        ...
                        previousOrderAmount =data.response_data[0]._id.transactionAmount
    ...
    let promise = new Promise(  function(resolve, reject) {
        ...
        checkResponse.map( async function(data) { 
                    ...
                    if(data.response_data.length>=1 )
                    {
                        ...
                        previousOrderAmount =data.response_data[index]._id.transactionAmount
